           ...
           <section className='modalBox popupForm'>
                ...
                <form className="bg-[#F6F6F6] shadow-md rounded-3xl px-4 sm:px-8 pt-10 pb-10 mb-4 flex flex-col max-w-lg mx-auto">
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded-[42px] w-full py-3.5 px-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="creator_name" type="text" placeholder="Full Name" required />
                    </div>
                    <div className="mb-4">
                        {/* <label className="block text-gray-700 text-sm font-bold mb-2" for="number">
                            Mobile/WA Number
                        </label> */}
                        <input className="shadow appearance-none border rounded-[42px] w-full py-3.5 px-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="number" type="text" placeholder="Brand/Company Name" />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-6">
                        ...
                        <input className="shadow appearance-none border rounded-[42px] w-full py-3.5 px-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="number" placeholder="Phone Number / WhatsApp Number" required />
                    </div>
