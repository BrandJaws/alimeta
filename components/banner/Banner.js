...
function Banner() {
    return (
        <div className='BannerSection'>
            ...
            <video className='Bannervideo mobile-only'  poster="https://animeta.ai/images/poster.jpg"  autoPlay loop muted playsInline>
                <source src="https://d3e066o7tnnbih.cloudfront.net/banner_video_updated.mp4" />
            </video>
        </div>
    )
}
